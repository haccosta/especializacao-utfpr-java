        ...
        boolean encontradoVeiculoPlaca = false;
            ...
            for (int i = 0; i < vetorVeiculoCarga.length; i++) {
                if (vetorVeiculoCarga[i]!= null
                        && !vetorVeiculoCarga[i].getPlaca().isEmpty()
                        && vetorVeiculoCarga[i].getPlaca().equalsIgnoreCase(carga.getPlaca())) {
        ...
        boolean encontradoVeiculoPlaca = false;
            ...
            for (int i = 0; i < vetorVeiculoPasseio.length; i++) {
                if (vetorVeiculoPasseio[i]!= null
                        && !vetorVeiculoPasseio[i].getPlaca().isEmpty()
                        && vetorVeiculoPasseio[i].getPlaca().equalsIgnoreCase(passeio.getPlaca())) {
                    encontradoVeiculoPlaca = true;
