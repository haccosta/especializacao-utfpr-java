public class Teste {
    ...
    private static Passeio vetorVeiculoPasseio[] = new Passeio[5];
    private static Carga vetorVeiculoCarga[] = new Carga[5];
    ...
    public static void main(String args[]) {
        ...
        while (continuaPrograma) {
            ...
            switch (opcaoEscolhida) {
                case 1:
                    for (int i = procurarPosicaoVagaPasseio(); i < vetorVeiculoPasseio.length; i++) {
                        ...
                        boolean encontradoMesmaPlacaPasseio = false;

                        for (int j = 0; j < vetorVeiculoPasseio.length; j++) {
                            if (vetorVeiculoPasseio[j] != null && vetorVeiculoPasseio[j].getPlaca().equalsIgnoreCase(veiculoPasseio.getPlaca())) {
                                encontradoMesmaPlacaPasseio = true;
                            }

                        }

                        if (encontradoMesmaPlacaPasseio) {
                            entrada.lerDados("\n\n\n\t\t\t=========Ja temos um veiculo de PASSEIO cadastrado com essa placa -  pressione a tecla <ENTER>");
                        } else {
                            vetorVeiculoPasseio[i] = veiculoPasseio;
                        }
                ...
                case 2:
                    for (int i = procurarPosicaoVagaCarga(); i < vetorVeiculoCarga.length; i++) {
                        if (i == -1) {
                        ...
                        boolean encontradoMesmaPlacaCarga = false;

                        for (int j = 0; j < vetorVeiculoCarga.length; j++) {
                            if (vetorVeiculoCarga[j] != null && vetorVeiculoCarga[j].getPlaca().equalsIgnoreCase(veiculoCarga.getPlaca())) {
                                encontradoMesmaPlacaCarga = true;
                            }

                        }

                        if (encontradoMesmaPlacaCarga) {
                            entrada.lerDados("\n\n\n\t\t\t=========Ja temos um veiculo de CARGA cadastrado com essa placa -  pressione a tecla <ENTER>");
                        } else {
                            vetorVeiculoCarga[i] = veiculoCarga;
                        }
                ...
                case 3:
                    ...
                    for (int i = 0; i < vetorVeiculoPasseio.length; i++) {
                        if (vetorVeiculoPasseio[i] != null) {
                            imprimirDadosVeiculoPasseio(vetorVeiculoPasseio[i], i);
                        } else {
                ...
                case 4:
                    ...
                    for (int i = 0; i < vetorVeiculoCarga.length; i++) {
                        if (vetorVeiculoCarga[i] != null) {
                            imprimirDadosVeiculoCarga(vetorVeiculoCarga[i], i);
                        } else {
                ...
                case 5:
                    ...
                    for (int i = 0; i < vetorVeiculoPasseio.length; i++) {
                        if (vetorVeiculoPasseio[i].getPlaca().equalsIgnoreCase(placaDesejadaPasseio)) {
                            imprimirDadosVeiculoPasseio(vetorVeiculoPasseio[i], i);
                ...
                case 6:
                    ...
                    for (int i = 0; i < vetorVeiculoCarga.length; i++) {
                        if (vetorVeiculoCarga[i].getPlaca().equalsIgnoreCase(placaDesejadaCarga)) {
                            imprimirDadosVeiculoCarga(vetorVeiculoCarga[i], i);
